...
export const SearchMatchingResults = ({
  ...
  <Card className="z-50 -mt-4 w-full overflow-hidden !rounded-lg !bg-transparent !p-0 !transition-all">
    <ul className="flex flex-col gap-y-[1px] ">
      {currentPlaces.map((place, index) => (
        <li key={index} className="w-full bg-gray-200 dark:bg-gray-500">
          <button
            type="button"
            className="flex w-full !px-5 !py-4 text-start text-md text-gray-600 dark:text-gray-100"
